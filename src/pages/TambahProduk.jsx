...
import { changeInput, doPostProduk } from "../store/action/produk";

class TambahProduk extends Component {
  postProduk = async () => {
    await this.props.doPostProduk();
    const isAddProduk = this.props.dataProduk.isAddProduk;
    console.log(isAddProduk);
    if (isAddProduk) {
